          ...
          <div class="preview-container">
            <div id="printable-report" class="printable-report">
              <div class="report-header">
                <h1>📊 iNavPark Guide Analytics Report</h1>
              ...
              <div class="report-footer">
                <p>
                  This report was automatically generated by iNavPark Guide
                  Analytics System
                </p>
                <p>© 2025 iNavPark Guide AR Navigation - All Rights Reserved</p>
              </div>
            </div>
          </div>
        </div>
  ...
  methods: {
    ...
    printFromPreview() {
      ...
      printWindow.document.write(`
        ...
        <html>
        <head>
          <title>iNavPark Guide Analytics Report</title>
          <style>
        ...
        <body>
          <div class="report-header">
            <div class="report-logo">
              <h1>🌾 iNavPark Guide AR Navigation</h1>
          ...
          <div class="report-footer">
            <p>This report was automatically generated by iNavPark Guide Analytics System</p>
            <p>© 2025 iNavPark Guide AR Navigation - All Rights Reserved</p>
          </div>
        </body>
        </html>
    ...
    async printReport() {
      ...
      printWindow.document.write(`
        ...
        <html>
        <head>
          <title>iNavPark Guide Analytics Report - ${this.formatDate(
            new Date()
          )}</title>
          <style>
    ...
    async downloadPDF() {
      ...
      const options = {
        ...
        filename: `iNavPark Guide-Analytics-Report-${
